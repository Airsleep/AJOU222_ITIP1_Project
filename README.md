...
- exec_app.py
  - 간단하게 본 프로그램을 사용하고 싶을 경우에는 exec_app.py를 실행시키면 됩니다. 입력으로는 문제를 추천받고 싶어하는 사용자의 백준 아이디와 SB를 설정해주어야 하는데 SB에 대해서는 아래에서 설명을 하고 있으나 5, 10, 20의 숫자 중에서 사용하는 것을 추천합니다.
